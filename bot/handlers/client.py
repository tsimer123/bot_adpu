...
from bot.handlers.emeter import command_emeter
...
def register_handler_client(db: Dispatcher):
    ...
    dp.register_message_handler(command_ips, commands=['ips'])
    ...
    dp.register_message_handler(command_emeter, commands=['emeter'])
